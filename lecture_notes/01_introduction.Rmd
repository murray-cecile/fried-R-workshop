...
We can see that `crimes` is now an object in our environment. We can click on it to view it. 

Crimes is a data frame, which is basically a more sophisticated kind of matrix.

```{r explore_crimes}
# this is the same as clicking on it
View(crimes)

# and this is a way of looking at it in the console
glimpse(crimes)
